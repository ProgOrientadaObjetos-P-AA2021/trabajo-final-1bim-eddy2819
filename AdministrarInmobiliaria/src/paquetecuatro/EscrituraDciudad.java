...
public class EscrituraDciudad {
    ...
    public void establecerLista() {
        LecturaDciudad l = new LecturaDciudad(obtenerNombreArchivo());
        l.establecerListaCiudadD();
        lista = l.obtenerListaCiudadD();
    }
